...
function createMenu(obj) {
  return {
    ...
    pay() {
      let valuetobePayed = 0;
      const internalConsum = this.consumption;
      ...
      for (let i = 0; i <= internalConsum.length; i += 1) {
        lal(arr1[0][internalConsum[i]]);
        lal(arr1[1][internalConsum[i]]);
      }
