...
describe('#productDetails', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    const output = productDetails('teste1','teste2');
    ...
    assert.strictEqual((output[0].details.productId).endsWith('123'), true);
    assert.strictEqual((output[1].details.productId).endsWith('123'), true);
  });
}); 
