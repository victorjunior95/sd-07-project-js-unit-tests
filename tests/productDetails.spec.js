...
describe('#productDetails', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.deepStrictEqual(typeof productDetails('Alcool gel', 'Máscara')[0], typeof productDetails('Alcool gel', 'Máscara')[1]);
    // (Difícil) Teste que os dois productIds terminam com 123.
    // console.log(productDetails('Alcool gel', 'Máscara')[0].details.productId.substring('123'));
