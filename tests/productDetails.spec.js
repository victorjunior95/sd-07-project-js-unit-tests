...
describe('#productDetails', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.strictEqual(Object.values(productDetails('Álcool Gel', 'Máscara')).length , 2);
    ...
    assert.strictEqual(Object.values(productDetails('Alcool gel', 'Máscara'))[0].details.productId.slice(-3), '123');
  });
});
