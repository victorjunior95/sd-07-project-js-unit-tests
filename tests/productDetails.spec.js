...
*/
const endProductId1 = productDetails('Alcool')[0].details.productId.substr(-3, 3);
const endProductId2 = productDetails('Gel')[1].details.productId.substr(-3, 3);
...
describe('#productDetails', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.strictEqual(endProductId1 && endProductId2, '123');
  });
});
