...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.deepStrictEqual(createMenu({food: {'coxinha': 3.9, 'sopa': 9.9,}}).fetchMenu, { food: { coxinha: 3.9, sopa: 9.9 } });
    ...
    const objetoRetornado = createMenu({food: {'coxinha': 3.9, 'sopa': 9.9,}});
    objetoRetornado.order('coxinha');
    ...
    // ```
    const objetoRetornado1 = createMenu({food: {'coxinha': 3, 'sopa': 9,}});
    objetoRetornado1.order('sopa');
    objetoRetornado1.order('coxinha');
    assert.deepStrictEqual(objetoRetornado1.pay(), 13.20);
