...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.deepStrictEqual((Object.keys(createMenu(objetoQualquer).fetchMenu)), ['food', 'drink']);
    //const objetoRetornado = createMenu(objetoQualquer);
    ...
    // objetoRetornado.order('agua');
    // objetoRetornado.order('coxinha');
    objetoRetornado.pay(objetoQualquer);
    assert.strictEqual(parseFloat((objetoRetornado.pay().toPrecision(4))), 27.06)
