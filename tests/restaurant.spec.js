...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    drinks: {'agua': 3.90, 'cerveja': 6.90}};
    const objetoRetornado = createMenu(objeto);
    ...
    assert.deepStrictEqual(objetoRetornado.fetchMenu, objeto);
    // ```
    ...
    // ```;
    const objetoRetornado2 = createMenu(objeto);
    ...
    const objetoRetornado3 = createMenu(objeto);
    ...
    const objetoRetornado4 = createMenu(objeto);
    ...
    assert.strictEqual(objetoRetornado4.pay(), 12.87);
