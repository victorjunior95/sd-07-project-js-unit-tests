...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.deepStrictEqual(result.fetchMenu, expected);
    ...
    result = createMenu(obj);
    expected = obj;
    assert.deepStrictEqual(result.fetchMenu, obj);
    ...
    assert.deepStrictEqual(result.consumption, expected);
    // objetoRetornado.order("coxinha");
    ...
    // result.order('coxinha');
    // result.order('agua');
    // expected = (3.90 + 3.90 + 3.90) * 1.1;

    // objetoRetornado.pay() // Retorno: somaDosPreçosDosPedidos

    // assert.strictEqual(result.pay(), expected);
