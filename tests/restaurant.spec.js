...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.deepStrictEqual(createMenu({ comida: 'ovo' }), {fetchMenu: { comida: 'ovo' }});
    ...
    assert.deepStrictEqual(createMenu({ comida: 'ovo' }).fetchMenu, {
      comida: 'ovo',
    });
    ...
    assert.deepStrictEqual(meuRestauranteOficial.consumption, []);
    ...
    assert.deepStrictEqual(meuRestauranteOficial.consumption, ['coxinha']);
    ...
    assert.deepStrictEqual(meuRestauranteOficial.consumption, [ 'coxinha', 'agua', 'sopa', 'sashimi' ]);
    ...
    assert.deepStrictEqual(meuRestauranteOficial.consumption, [ 'coxinha', 'agua', 'sopa', 'sashimi', 'coxinha' ]);
    ...
    assert.deepStrictEqual(meuRestauranteOficial.pay(), 28.5);
