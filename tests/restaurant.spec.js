...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.deepStrictEqual(createMenu({food: {'coxinha': 3.90, 'sanduiche': 9.90},
    drinks: {'agua': 3.90, 'cerveja': 6.90}}), meuRestaurante);
    // ```
    ...
    const objetoRetornado1 = createMenu({food: {'coxinha': 3.90, 'sanduiche': 9.90},
    drinks: {'agua': 3.90, 'cerveja': 6.90}});
    assert.deepStrictEqual(objetoRetornado1.fetchMenu, {food: {'coxinha': 3.90, 'sanduiche': 9.90},
    drinks: {'agua': 3.90, 'cerveja': 6.90}});
    // ```
    ...
    const objetoRetornado3 = createMenu({food: {'coxinha': 3.90, 'sanduiche': 9.90, 'sopa': 12.90, 'sashimi': 15.90},
    drinks: {'agua': 3.90, 'cerveja': 6.90}});
    ...
    const objetoRetornado4 = createMenu({food: {'coxinha': 3.90, 'sanduiche': 9.90},
    drinks: {'agua': 3.90, 'cerveja': 6.90}});
    ...
    const objetoRetornado5 = createMenu({food: {'coxinha': 3.90, 'sanduiche': 9.90},
    drinks: {'agua': 3.90, 'cerveja': 6.90}});
    ...
    // Agora faça o PASSO 4 no arquivo `src/restaurant.js`.12.87
  });
});
