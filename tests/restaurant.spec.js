...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.deepStrictEqual(createMenu(objetotest), {fetchMenu: objetoQualquer}); // ```
    ...
    // ```
    assert.deepStrictEqual(createMenu(objTest).fetchMenu, objTest);
    // const objetoRetornado = createMenu(objetoQualquer);
    ...
    // ```
    assert.deepStrictEqual(createMenu(objTest).consumption, []);
    // const objetoRetornado = createMenu(objetoQualquer);
    ...
    // ```;
    const contaCliente = createMenu(objTest);
    contaCliente.order('coxinha');
    assert.deepStrictEqual(contaCliente.consumption[0], 'coxinha')
    // const objetoRetornado = createMenu(objetoQualquer);
    ...
    contaCliente.order("sopa");
    contaCliente.order("sashimi");
    assert.deepStrictEqual(contaCliente.consumption, ["coxinha", "agua", "sopa", "sashimi"]);
    // objetoRetornado.order("coxinha");
    ...
    // ```
    contaCliente.order('coxinha');
    assert.deepStrictEqual(contaCliente.consumption, ["coxinha", "agua", "sopa", "sashimi", 'coxinha']);
    // objetoRetornado.order('coxinha');
    // objetoRetornado.order('agua');
    // objetoRetornado.order('coxinha');
    ...
    // ```
    const contaCliente2 = createMenu(objTest);
    contaCliente2.order('coxinha');
    contaCliente2.order("agua");
    contaCliente2.order('coxinha');
    assert.strictEqual(contaCliente2.pay(), 12.87);
    // objetoRetornado.order('coxinha');
    // objetoRetornado.order('agua');
    // objetoRetornado.order('coxinha');
