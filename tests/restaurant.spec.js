...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    // ```
    // assert.deepStrictEqual(createMenu(objetoQualquer), { fetchMenu: objetoQualquer }); OK
    ...
    // ```
    assert.deepStrictEqual(objetoRetornado.fetchMenu, { food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9 } });
    ...
    // ```
    assert.strictEqual(objetoRetornado.pay(), 10)
