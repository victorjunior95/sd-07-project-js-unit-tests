...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    let objetoRetornado = createMenu(menuTeste);
    assert.deepStrictEqual(Object.keys(objetoRetornado.fetchMenu), [ 'food', 'drink' ], 'the return should be { food: {}, drink: {} }');
    // Agora faça o TESTE 3 deste arquivo.
    // --------------------------------------------------------------------------------------
    // TESTE 3: Verifique que o menu passado pra função createMenu é identico ao menu recuperado pela função 'objetoRetornado.fetchMenu'
    // const objetoRetornado = createMenu(objetoQualquer);
    // objetoRetornado.fetchMenu // Retorno: objetoQualquer
    assert.deepStrictEqual(objetoRetornado.fetchMenu, menuTeste);
    ...
    assert.deepStrictEqual(objetoRetornado.consumption, ['coxinha'], 'the return is expected to be an array with value ["coxinha"]'); // Retorno: ["coxinha"]
    // ```
    ...
    assert.deepStrictEqual(objetoRetornado.consumption, ["coxinha", "agua", "sopa", "sashimi"], 'the return is expected to be an array with value ["coxinha", "agua", "sopa", "sashimi"]' );
    ...
    // objetoRetornado.order('agua');
    objetoRetornado.order('coxinha');
    assert.deepStrictEqual(objetoRetornado.consumption, ["coxinha", "agua", "sopa", "sashimi", "coxinha"], 'the return is expected to be an array with value ["coxinha", "agua", "sopa", "sashimi", "coxinha"]' );
    ...
    objetoRetornado.order('agua');
    objetoRetornado.order('coxinha');
    assert.deepStrictEqual(objetoRetornado.pay(), 11.7, 'the return is expect to be 11.7');
