...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    // ```
    const objectMenu = { food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9} };
    assert.deepStrictEqual(typeof createMenu(objectMenu), 'object');
    ...
    // ```
    // assert.deepStrictEqual(obejctMenu, createMenu(objectMenu).fetchMenu);
    ...
    // ```
    assert.deepStrictEqual(createMenu(objectMenu).consumption, []);
    ...
    // ```
    const returnedObject = createMenu(objectMenu);
