...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    // assert.strictEqual(createMenu(object).order)
    // const objetoRetornado = createMenu(objetoQualquer);
    ...
    let objectTest = createMenu(object);
    let received = objectTest.fetchMenu;
    assert.deepStrictEqual(received, object);
    assert.deepStrictEqual(Object.keys(received), [ 'food', 'drink']);
    assert.deepStrictEqual(objectTest.consumption, []);
    
    objectTest = createMenu(object);
    objectTest.order('coxinha');
    received = objectTest.consumption;
    assert.deepStrictEqual(received, ['coxinha']);
    
    objectTest = createMenu(object);
    objectTest.order('coxinha');
    objectTest.order('agua');
    objectTest.order('sopa');
    objectTest.order('sashimi');
    received = objectTest.consumption;
    assert.deepStrictEqual(received, ['coxinha', 'agua', 'sopa', 'sashimi']);
    ...
    objectTest.order('coxinha');
    received = objectTest.consumption;
    assert.deepStrictEqual(received, ['coxinha', 'agua', 'coxinha']);
    ...
    objectTest.order('agua');
    objectTest.order('coxinha');
    received = objectTest.pay();
    assert.deepStrictEqual(received, '12.87');
  });
});
