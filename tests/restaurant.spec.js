...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    let expected = { fetchMenu: menuRestaurante };
    let chave = Object.keys(createMenu(menuRestaurante));
    let valor = Object.values(createMenu(menuRestaurante));
    let received = { [chave[0]]: valor[0], };
    ...
    expected = Object.keys(menuRestaurante);
    received = Object.keys(createMenu(menuRestaurante).fetchMenu);
    assert.deepStrictEqual(received, expected);
    ...
    received = createMenu(menuRestaurante).fetchMenu;
    assert.deepStrictEqual(received, menuRestaurante);
    // const objetoRetornado = createMenu(objetoQualquer);
    ...
    expected = [];
    received = createMenu(menuRestaurante).consumption;
    assert.deepStrictEqual(received, expected);
    // const objetoRetornado = createMenu(objetoQualquer);
    ...
    let objectReturned = createMenu(menuRestaurante);
    objectReturned.order('coxinha');
    expected = ['coxinha'];
    received = objectReturned.consumption;
    assert.deepStrictEqual(received, expected);
    // ```;
    // const objetoRetornado = createMenu(objetoQualquer);
