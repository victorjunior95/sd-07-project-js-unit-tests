...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.strictEqual(typeof createMenu('objeto'), 'object')
    ...
    assert.strictEqual(createMenu('objetoQualquer').consumption, '[]')
    ...
    assert.strictEqual(createMenu('coxinha').consumption, "['coxinha']")
