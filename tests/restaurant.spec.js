...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    const firstMenu = createMenu({ food: {}, drink: {} });
    assert.deepStrictEqual(firstMenu.fetchMenu, { food: {}, drink: {} });
    // ```
    ...
    const secondMenu = createMenu(menu);
    assert.deepStrictEqual(secondMenu.fetchMenu, menu);
    // ```
    // const objetoRetornado = createMenu(objetoQualquer);
    ...
    const thirdMenu = createMenu(menu)
    assert.deepStrictEqual(thirdMenu.consumption, []);
    // ```
    // const objetoRetornado = createMenu(objetoQualquer);
    ...
    const fourthMenu = createMenu(menu);
    fourthMenu.order('coxinha');
    assert.deepStrictEqual(fourthMenu.consumption, ['coxinha']);
    // ```;
    // const objetoRetornado = createMenu(objetoQualquer);
    ...
    fourthMenu.order('agua');
    fourthMenu.order('sopa');
    fourthMenu.order('sashimi');
    assert.deepStrictEqual(fourthMenu.consumption, ["coxinha", "agua", "sopa", "sashimi"]);
    // ```
    // objetoRetornado.order("coxinha");
    ...
    const fifthMenu = createMenu(menu);
    fifthMenu.consumption = [];
    fifthMenu.order('coxinha');
    fifthMenu.order('agua');
    fifthMenu.order('coxinha');
    assert.deepStrictEqual(fifthMenu.consumption, ['coxinha', 'agua', 'coxinha']);
    // ```
    // objetoRetornado.order('coxinha');
    // objetoRetornado.order('agua');
    // objetoRetornado.order('coxinha');
    ...
    const sixthMenu = createMenu(menu);
    sixthMenu.order('coxinha');
    sixthMenu.order('agua');
    sixthMenu.order('coxinha');
    assert.deepStrictEqual(sixthMenu.pay(), 12.87);
    // ```
    // objetoRetornado.order('coxinha');
    // objetoRetornado.order('agua');
    // objetoRetornado.order('coxinha');
