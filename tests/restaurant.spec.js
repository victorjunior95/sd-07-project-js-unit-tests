...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    let objetoRetornado = { food: {}, drink: {}};
    //assert.fail();
    ...
    assert.deepStrictEqual(Object.entries(createMenu(objetoRetornado))[0], ['fetchMenu', objetoRetornado]);
    // ```
    ...
    assert.deepStrictEqual(Object.keys(createMenu(objetoRetornado).fetchMenu), [ 'food', 'drink' ]);
    // ```
    ...
    assert.deepStrictEqual(createMenu(objetoRetornado).consumption, []);
    // ```
    // const objetoRetornado = createMenu(objetoQualquer);
