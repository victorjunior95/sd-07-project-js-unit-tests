...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    // ```
    assert.deepStrictEqual((createMenu(objetoQualquer)).fetchMenu, {food: {}, drink: {}})
    ...
    // ```
    assert.deepStrictEqual(createMenu(objetoQualquer).order('coxinha').consumption, ['coxinha']);
