...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    result = 'objetoQualquer';
    expected = 'objetoQualquer';
    ...
    result = createMenu({ food: {}, drink: {} }).fetchMenu();
    expected = { food: {}, drink: {} };
    assert.deepStrictEqual(result, expected);
    ...
    objQualquer = { food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9} }
    result = createMenu(objQualquer).fetchMenu();
    expected = { food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9} };
    assert.deepStrictEqual(result, expected);
    ...
    objQualquer = { food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9} }
    result = createMenu(objQualquer).consumption();
    expected = [];
    assert.deepStrictEqual(result, expected);
    ...
    result = menuQualquer.consumption();
    expected = ["coxinha"];
    assert.deepStrictEqual(result, expected);
    ...
    menuQualquer.order("sopa")
    menuQualquer.order("sashimi")
    result = menuQualquer.consumption();
    ...
    menuQualquer = createMenu({ food: {'coxinha': 3, 'sopa': 9.9}, drink: {'agua': 3, 'cerveja': 6.9} })
    menuQualquer.order("coxinha")
    menuQualquer.order("agua")
    menuQualquer.order("coxinha")
    result = menuQualquer.pay();
    expected = 9;
    assert.deepStrictEqual(result, expected);
