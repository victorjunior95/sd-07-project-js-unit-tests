...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.deepStrictEqual(createMenu({food: 'coxinha', drink: 'cerveja'}).fetchMenu, { food: 'coxinha', drink: 'cerveja' });
    // const objetoRetornado = createMenu(objetoQualquer);
    ...
    assert.deepStrictEqual(createMenu({food: 'coxinha', drink: 'cerveja'}).consumption, []);
    // const objetoRetornado = createMenu(objetoQualquer);
    ...
    //assert.deepStrictEqual(restaurant('coxinha'), { order: [Function: order] })
    // const objetoRetornado = createMenu(objetoQualquer);
