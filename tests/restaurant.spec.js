...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    // ```
    const teste5 = () => {
      const obj = createMenu({ food: {} });
      obj.order('coxinha');

      return obj.consumption;
    }
    assert.deepStrictEqual(teste5(), ['coxinha']);
    ...
    assert.deepStrictEqual(teste6(), ['coxinha', 'agua', 'sopa', 'sashimi']);
    ...
    assert.deepStrictEqual(teste7(), ['coxinha', 'agua', 'coxinha']);
