...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    const objectInput = { food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9} }
    const result = createMenu(objectInput);
    assert.deepStrictEqual(result.fetchMenu, { food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9}});
    // --------------------------------------------------------------------------------------
    ...
    assert.deepStrictEqual(Object.keys(result.fetchMenu), Object.keys(objectInput));
    // --------------------------------------------------------------------------------------
    ...
    assert.deepStrictEqual(result.fetchMenu, objectInput)
    // --------------------------------------------------------------------------------------
    ...
    assert.deepStrictEqual(result.consumption, [])
    // --------------------------------------------------------------------------------------
    ...
    result.order('agua')
    result.order('sopa')
    result.order('sashimi')
    assert.deepStrictEqual(result.consumption, ['coxinha', 'agua', 'sopa', 'sashimi'])
    // --------------------------------------------------------------------------------------
    ...
    result.order('agua')
    assert.deepStrictEqual(result.consumption, ['coxinha', 'agua', 'sopa', 'sashimi', 'agua'])
    // --------------------------------------------------------------------------------------
    ...
    const resultCalc = createMenu(objectInput);
    resultCalc.order('agua')
    resultCalc.order('coxinha')
    resultCalc.order('coxinha')

    assert.strictEqual(resultCalc.pay(), 11.7)
  });
});
