...
describe('#circle', () => {
  it('given a radius, should return an object with circles info', () => {
    ...
    const out = {}
    out.radius = parseFloat(circle(3).radius.toPrecision(4));
    out.area = parseFloat(circle(3).area.toPrecision(4));
    out.circumference = parseFloat(circle(3).circumference.toPrecision(4));
