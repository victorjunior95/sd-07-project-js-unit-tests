...
describe('#circle', () => {
  it('given a radius, should return an object with circles info', () => {
    ...
    // Teste se o objeto retornado tem 3 entradas.
     const entrada = Object.entries(circle(1)).length;
     assert.strictEqual(entrada, 3);
    ...
    ssert.strictEqual(circle(3).radius, 3);
    assert.strictEqual(circle(3).area, 28,26);
    assert.strictEqual(circle(2).circumference, 18,84);
  });
});