...
describe('#circle', () => {
  it('given a radius, should return an object with circles info', () => {
    ...
    assert.deepStrictEqual({radius: 3, area: parseFloat(circle(3).area.toPrecision(4)), circumference: circle(3).circumference}, {radius: 3, area: 28.26, circumference: 18.84});
  });
});
